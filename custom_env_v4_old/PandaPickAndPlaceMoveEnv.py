...
from PandaPickAndPlaceTask import PandaPickAndPlaceMoveTask
...
class PandaPickAndPlaceMoveEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "sparse", control_type: str = "ee") -> None:
        ...
        task = PandaPickAndPlaceMoveTask(sim, reward_type=reward_type, get_ee_position=robot.get_ee_position)
